...
public class UsersDaoImpl extends HibernateDaoSupport implements UsersDao {
	...
	public List<Users> getUsersList(Users users) {
		...
		if (StringUtils.isNotBlank(users.getAddr())) {
			query.setString("addr", users.getAddr());
		}
		if (users.getPhone() != null) {
			query.setInteger("phone", users.getPhone());
		}
	...
	public int getUsersCount(Users users) {
		...
		if (StringUtils.isNotBlank(users.getAddr())) {
			c.add(Restrictions.eq("addr", users.getAddr()));
		}
		if (users.getPhone() != null) {
			c.add(Restrictions.eq("phone", users.getPhone()));
		}
