...
<table align="center" border="1" cellspacing="0" width="880">
	<tr>
		<th>id</th>
		<th align="left">
		...
		<th>地址</th>
		<th align="left">
			<input type="text" name="users.addr" value="${users.addr}" />
		</th>
		<th>姓名</th>
		<th align="left">
	...
	<tr>
		...
		<th colspan="2"><input type="submit" value="查询"/>&nbsp;&nbsp;
...
<input type="hidden" name="users.addr" value="${users.addr}" />
